		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#mmpracticeproject1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mmpracticeproject1-display": {
								"semanticObject": "mmpracticeproject1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mm.practiceproject1",
									"url": sap.ui.require.toUrl("mm/practiceproject1")
								}
							}
						}
					}
